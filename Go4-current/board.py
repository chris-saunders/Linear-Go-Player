...
class GoBoard(object):
    ...
    def reset(self, size):
        ...
        self._linear_filling(self.board) #This instead makes only the top row empty

        #self.board=0*np.ones((size,),dtype=np.int16) #This makes a linear board
    ...
    def _linear_filling(self,board):
        ...
        board : numpy array
            ...
            This is kinda gross right now only works for size 10
        """
        for ind in range(12,22):
            np.put(board,ind, EMPTY)
