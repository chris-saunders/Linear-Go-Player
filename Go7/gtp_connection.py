...
class GtpConnection():
    ...
    def __init__(self, go_engine, debug_mode = False):
        ...
        self.commands = {
            ...
            "superko": self.showSuperko_cmd,
            "help":self.list_commands_cmd,
            "?":self.list_commands_cmd
        }
        ...
        self.argmap = {
            ...
            "superko": (0, "Usage: Does not have arguments")
        }
    def __del__(self):
    ...
    def showSuperko_cmd(self):
        self.respond(self.board.getSuperko)
    ...
    def showboard_cmd(self, args):
        ...
        #self.respond('\n' + str(self.board.get_twoD_board())) #This is the regular function
        self.respond('\n'+str(self.board.board[size+2:size *2+2])) #This prints out the top row of a 10x10 (Should now work for all sizes)
